...
<div class="inventory-fourth-function inventory-function">
    <div class="second-header">
        ...
        <a href="addData.php?inventoryNav=inventoryFourth&data=addPro" class="btn-link"><?= $main['Thêm'] ?></a>
        </button>
    </div>
                    ...
                    ?>
                        <tr>
                            ...
                            <?php if (checkPrivilege('addData.php?inventoryNav='.$tam.'&data=delete&id='.$row['id'])) { ?>
                                <a href="addData.php?inventoryNav=<?= $tam ?>&data=edit&id=<?= $row['id'] ?>" class="third-table-see"><?= $main['Sửa'] ?></a>
                            <?php } ?>
