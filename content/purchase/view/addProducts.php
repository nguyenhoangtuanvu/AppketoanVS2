...
<div class="form-content display-center">
    <form method="POST" action="<?= $_GET['data'] == 'edit' ? "addData.php?purchaseNav=$tam&action=editPro&id=" . $_GET['id'] : "addData.php?data=$stt&action=addPro" ?>" class="second-table form-table-50-100">
        <div class="row">
